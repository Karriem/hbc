...
object CarePlanModel {
  ...
  class CarePlanRepo(tag:Tag) extends Table[CarePlan](tag, "CAREPLAN"){
      ...
      def timeFrame = column[Date]("END_DATE")
      ...
      def * = (planId, description, startDate, timeFrame, patientId, coordinatorId, problem, caregiverId) <> (CarePlan.tupled, CarePlan.unapply)
